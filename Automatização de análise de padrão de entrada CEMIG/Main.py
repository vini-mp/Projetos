...
class TreeViewApp:
    def __init__(self, root):
        ...
        def se_micro():
            ...
            quantidade_microinversorAB = ctk.CTkEntry(frame_ab, placeholder_text="", width=150, height=30, border_width=2, corner_radius=10,bg_color='#ebebeb',fg_color='white')
            ...
            #Manter a janela na frente das demais 
            new_window.lift()
        ...
        def se_inversor():
            ...
            ctk.CTkLabel(new_window, text="Classe de instalação do inversor: ", font=("arial bold", 14), bg_color='#ebebeb', text_color='black').pack()
            ...
            ctk.CTkLabel(new_window, text="Tensão de operação do inversor: ", font=("arial bold", 14), bg_color='#ebebeb', text_color='black').pack()
        ...
        def se_erro(mensagem):
            ...
            #Manter a janela de erro na frente das demais
            erro_window.lift()
